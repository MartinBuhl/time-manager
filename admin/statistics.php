...
<title><?= h(t('stats.pageTitle')) ?></title>
...
<div class="admin-page">
    ...
    <div class="admin-header">
        <div>
            <h1><?= h(t('admin.card.statistics')) ?></h1>
            <div class="admin-breadcrumb">
                <a href="index.php"><?= h(t('admin.title')) ?></a> &rsaquo; <?= h(t('admin.card.statistics')) ?>
            </div>
        </div>
